import { ButtonDiv, CarrinhoButton, CarrinhoImg, CarrinhoValor, DivCarrinhoCompra, DivNavbarTitle, NavbarContainer, NavbarTitle, NavbarTitleSub } from "../styles/NavbarStyled";
