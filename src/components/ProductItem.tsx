...
import { ButtonBuy, DivBuyIcon, DivBuyWrite, DivCard, DivDescription, DivImgProduct, DivNamePriceProduct, DivNameProduct, DivPriceProduct, ImgProduct } from "../styles/BodyStyled";
    ...
    return (
        <DivCard>
            ...
            <ButtonBuy type="button" onClick={() => dispatch(AddItem(product))}>
                <DivBuyIcon><CgShoppingBag size={20} />
                </DivBuyIcon>
